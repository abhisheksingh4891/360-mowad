            ...
            <div className="card-body p-4 p-lg-5 text-black">
                ...
                <form onSubmit={Submit} style={{fontFamily:'Raleway'}}>
                  ...
                  <div className="pt-2 mb-4 d-flex gap-4">
                    <Link to="/modal"><button className="btn btn-success btn-block" type="submit">AdminRegister</button></Link>
                    <button className="btn btn-success btn-block" type="submit">Reset</button>
                  </div>

                  <p className="mb-2 text-black fw-bold" style={{"color": "blue"}}>Already have an account? <Link to="/adminlogin"className="" style={{"color": "blue"}}>Login here</Link></p>
